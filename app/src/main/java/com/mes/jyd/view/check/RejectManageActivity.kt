...
class RejectManageActivity:scanActivity() {
    //参数
    var _title="不合格品处理"
    lateinit var listadapter: RejectManageAdapter
    lateinit var  vm: RejectManageViewModel
    ...
    override fun initParams(args: Bundle?) {
        //初始化参数
        vm= RejectManageViewModel(this, application.ctx)
        listadapter= RejectManageAdapter(vm)
